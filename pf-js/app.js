...
// Map ejecuta una función sobre cada elemento de un array y devuelve unu nuevo array con el resultado
...
// Filter sirve para filtrar elementos de un array, recibe una función de callback donde lo que retornemos debe ser una expreción boolean, y los elementos del array que cumplan esta condición seran guardados en un nuevo array.
...
const multiploDTres = numeros.filter((numero) => numero % 3 == 0);

console.log(multiploDTres);

//agregarle iva a cada elemento del array, 16% usando map, pero en vez deusar callback como ejemplo de multiplyBy3

function masIva(numero) {
  return numero * 1.16;
}
const numeroMasIva = numeros.map(masIva);
console.log(numeroMasIva);

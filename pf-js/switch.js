/**
 * *switch
 * todo Es una estructura de control condicional
 * todo Pero a diferencia del if no se basa en valores de verdad o de falso
 * todo Sino que se basa en opciones
 * ?nos permite tener multiples opciones
 * ? y con base en la opción seleccionada ejecutar un bloque de codigo
 ...
 * * ejemplos: una suma, usar una variable, usar una función
